...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "5AC0F" # Playfab Title Id
        self.SecretKey: str = "E7J1KHC3XB7FP6COPPRGFGEEBDSFYDP7FBUPAZIQH6SNZBU9MK" # Playfab Secret Key
        self.ApiKey: str = "OC|8638220072969349|34efa7e58fa8ab2fba22344ab77f7fe4" # App Api Key
